  ...
  XMLHttpRequest = (function() {
    ...
    class XMLHttpRequest extends XMLHttpRequestEventTarget {
      ...
      open(method, url, async, user, password) {
        ...
        // See test/url-encoding/readme.md
        // xhrUrl.path = encodeURI(decodeURI(xhrUrl.path));
        if (async === void 0) {
          async = true;
        }
      ...
      _finalizeHeaders() {
        ...
        if (typeof this._headers['User-Agent'] !== "string") {
    ...
    XMLHttpRequest.prototype._restrictedHeaders = {
      ...
      upgrade: true,
      // Allow user-agent overrides, this is safe on the backend.
      // 'user-agent': true,
      via: true
    };
