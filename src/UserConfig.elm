...
spanishTexts =
    ...
    , deleteGroupWarning = \groupName -> "Estas seguro de querer borrar " ++ groupName ++ " Si sí, por favor ingresar \"" ++ groupName ++ "\"."
    ...
    , inputDoesntMatchGroupName = "Ingreso no coincide con el nombre del grupo"
...
thaiTexts =
    ...
    , invalidUrlLong = "URL ไม่ถูกต้อง กรุณาใส่ URL ที่มีรูปแบบเช่น https://my-hangouts.com/ หรือปล่อยว่างไว้"
...
เงื่อนไขกฎหมายเหล่านี้เป็นสิ่งที่คุณและ meetdown.app ("เรา", "ของเรา", "Meetdown", ซอฟต์แวร์) ตกลงกัน คุณยอมรับเงื่อนไขเหล่านี้โดยการใช้บริการ Meetdown
