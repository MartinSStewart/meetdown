...
thaiTexts =
    ...
    , codeOfConduct3 = "• ให้ความเคารพกับผู้จัดกลุ่ม พวกเขาใช้เวลาในการจัดงานและพวกเขายินดีที่จะเชิญคนที่ไม่รู้จัก เด็ดขาดอย่าทำลายความไว้วางใจของพวกเขาในคุณ!"
    ...
    , codeOfConduct5 = "• ถ้ามีคนทำตัวเป็นคนไม่ดี คุณไม่ต้องทำตัวเป็นคนไม่ดีกลับ ขอให้พวกเขาหยุด และถ้าสิ่งนั้นไม่ทำงาน หลีกเลี่ยงพวกเขาและอธิบายปัญหาที่นี่ "
    , copyPreviousEvent = "คัดลอกกิจกรรมก่อนหน้านี้"
    , createEvent = "สร้างกิจกรรม"
    , createGroup = "สร้างกลุ่ม"
    , creatingOne = "การสร้าง"
    , creditGoesTo = " ความยินดีควรไปยัง "
    , dateValueMissing = "ขาดค่าวันที่"
...
"""
    ...
    , weDontSellYourDataWeDontShowAdsAndItsFree = "เราไม่ขายข้อมูลของคุณ เราไม่แสดงโฆษณา และมันฟรี."
    , welcomePage = "ยินดีต้อนรับสู่งาน!"
