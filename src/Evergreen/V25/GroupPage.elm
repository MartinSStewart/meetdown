module Evergreen.V25.GroupPage exposing (..)
...
type alias EditEvent =
    { submitStatus : SubmitStatus Evergreen.V25.Group.EditEventError
    , eventName : String
    , description : String
...
type EventOverlay
    = AddingNewEvent
    | EdittingEvent Evergreen.V25.Group.EventId EditEvent


type CreateEventError
    = EventStartsInThePast
    | EventOverlapsOtherEvents (AssocSet.Set Evergreen.V25.Group.EventId)
    | TooManyEvents
...
type EventJoinOrLeaveStatus
    = JoinOrLeavePending
    | LeaveFailure
    | JoinFailure Evergreen.V25.Group.JoinEventError


type alias Model =
    { name : Editable Evergreen.V25.GroupName.GroupName
    , description : Editable Evergreen.V25.Description.Description
    , eventOverlay : Maybe EventOverlay
    , newEvent : NewEvent
    , pendingJoinOrLeave : AssocList.Dict Evergreen.V25.Group.EventId EventJoinOrLeaveStatus
    , showAllFutureEvents : Bool
    , pendingEventCancelOrUncancel : AssocSet.Set Evergreen.V25.Group.EventId
    }
...
type Msg
    ...
    | PressedLeaveEvent Evergreen.V25.Group.EventId
    | PressedJoinEvent Evergreen.V25.Group.EventId
    | PressedEditEvent Evergreen.V25.Group.EventId
