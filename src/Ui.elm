...
import TestId exposing (ButtonId, DateInputId, HtmlId, NumberInputId, RadioButtonId, TextInputId, TimeInputId)
import Time
            ...
            List.Nonempty.map
                (\value ->
                    Element.Input.button
                        ...
                        , htmlId value |> TestId.htmlIdToString |> Html.Attributes.id |> Element.htmlAttribute
                        ]
    ...
    Element.column
        ...
        , Html.input
            ([ Html.Attributes.type_ "number"
             ...
             , TestId.htmlIdToString htmlId |> Html.Attributes.id
