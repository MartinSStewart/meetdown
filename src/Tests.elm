        ...
        |> loginFromHomepage False
            ...
            (\{ instructions, client } ->
                instructions
                    ...
                    |> client.inputText CreateGroupPage.nameInputId "groupName"
